...
public class ReportService {
    ...
    // Product
    public void createProductReport(String exportType,HttpServletResponse response) throws JRException, IOException {
        List<Product> productList = productRepository.findAll();
        exportProductReport(productList,exportType,response);
    }

    private void exportProductReport(Collection<?> beanCollection, String exportType, HttpServletResponse response) throws JRException, IOException {
        InputStream transactionReportStream =
                getClass()
                        .getResourceAsStream(
                                "/report/product_" + exportType.toLowerCase() + ".jrxml");
        if(transactionReportStream == null){
            throw new RuntimeException("Template file not found!");
        }
        String titleTransactionBy = "Product Report";
    ...
    public void createPublicKeyReport(String exportType, HttpServletResponse response) throws JRException, IOException {
        List<PublicKey> publicKeyList = publicKeyRepository.findAll();
        exportPublicKeyReport(publicKeyList, exportType, response);
    }

    public void exportPublicKeyReport(Collection<?> beanCollection, String exportType, HttpServletResponse response) throws JRException, IOException {
        InputStream transactionReportStream = getClass().getResourceAsStream("/report/public_" + exportType.toLowerCase() + ".jrxml");
        if (transactionReportStream == null) {
            throw new RuntimeException("Template file not found!");
        }

        String titleTransactionBy = "Public key Report";
    ...
    public void createJurusanReport(String exportType, HttpServletResponse response) throws JRException, IOException {
        List<Jurusan> jurusanList = jurusanRepository.findAll();
        exportJurusanReport(jurusanList, exportType, response);
    }

    public void exportJurusanReport(Collection<?> beanCollection, String exportType, HttpServletResponse response) throws JRException, IOException {
        InputStream transactionReportStream = getClass().getResourceAsStream("/report/jurusan_" + exportType.toLowerCase() + ".jrxml");
        if (transactionReportStream == null) {
            throw new RuntimeException("Template file not found!");
        }

        String titleTransactionBy = "Jurusan Report";
